...
[![Portfolio](https://img.shields.io/badge/Portfolio-arishwanthportfolio.netlify.app-00D9FF?style=for-the-badge&logo=netlify&logoColor=white)](https://arishwanthportfolio.netlify.app/)
[![GitHub](https://img.shields.io/badge/GitHub-Rishwanth05-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Rishwanth05)
[![Email](https://img.shields.io/badge/Email-arishwanthreddy%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:arishwanthreddy@gmail.com)
...
### 🛡️ [Project SAVE — Community Hazard Reporting Platform](https://github.com/Rishwanth05?tab=repositories)
> **Why it exists:** Built after witnessing how dangerous road and infrastructure hazards go unreported in India — SAVE gives communities a real-time voice to flag and track risks before someone gets hurt.

A full-stack public safety app where users pin, photo-report, and filter live hazard incidents on an interactive map. Engineered with React + Vite, Node.js, PostgreSQL, Redis, MapLibre GL, and Docker — with JWT auth and CI/CD via GitHub Actions.

`React` `Node.js` `PostgreSQL` `MapLibre GL` `Redis` `Docker` `JWT`

---

### 🏠 [House Price Prediction — Rental Market Analyzer](https://github.com/Rishwanth05?tab=repositories)
> **Why it exists:** After struggling to find affordable housing during his first weeks of grad school in the US, Rishwanth built the tool he wished had existed — a data-driven rental price predictor for students entering unfamiliar markets.

A machine learning pipeline that ingests, cleans, and models rental listing data to surface fair price estimates by location. Combines EDA, feature engineering, and predictive modeling to help renters make smarter decisions backed by data, not guesswork.

`Python` `Scikit-learn` `Pandas` `SQL` `Jupyter`
...
`Python` `SQL` `Tableau` `Power BI` `Data Modeling`
...
- 🔁 **Apache Iceberg & Data Vault 2.0** — next-gen lakehouse architecture patterns
- ☁️ **AWS Solutions Architect** — deepening multi-cloud design thinking
- 🤖 **LLM-powered data pipelines** — integrating AI into ETL workflows
...
[![Portfolio](https://img.shields.io/badge/🌐%20Portfolio-Visit%20Now-00D9FF?style=for-the-badge)](https://arishwanthportfolio.netlify.app/)
[![Email](https://img.shields.io/badge/📧%20Email-arishwanthreddy%40gmail.com-EA4335?style=for-the-badge)](mailto:arishwanthreddy@gmail.com)
[![GitHub](https://img.shields.io/badge/🐙%20GitHub-Rishwanth05-181717?style=for-the-badge)](https://github.com/Rishwanth05)
[![Instagram](https://img.shields.io/badge/📸%20Instagram-_rishwanth__reddy_-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/_rishwanth_reddy_/)
...
![Visitor Count](https://komarev.com/ghpvc/?username=Rishwanth05&color=00D9FF&style=flat-square&label=Profile+Views)
